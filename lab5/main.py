...
def main():
    ...
    Kc = real(exp(-dG/(R * t))) # расчёт константы равновесия
    x = 0.9999 * pow(10, 4) # решаем уравнение относительно x: Kc = (1.5*10^4+x)/((3*10^4-x)*(1*10^4-x))
    p1 = p_A - x
    p2 = p_B - x
    p3 = p_C + x
    ...
    print("Повышение давления сдвигает равновесие системы в сторону реагентов т.к. количество молей газообразных веществ в реагентах меньше чем в продуктах")
    ...
    print(f"Константа равновесия = {Kc}")
    print(f"Равновесные концентрации веществ: \nP1 = {p1} \nP2 = {p2} \nP3 = {p3}")
    print(f"Равновесная степень превращения для вещества А (SO2): {A}")
    # print(round(((1335625000-5000*pow(17839742779, 0.5))/66781), 4)) # x1
    # print(round(((1335625000+5000*pow(17839742779, 0.5))/66781), 4)) # x2
